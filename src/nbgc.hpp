...
class Image {
	public:
		...
		//Constructeur de la classe Image
		//Prend un pointeur vers une autre Image. (Permets de construire une Image avec "this").
		Image(Image *img);
		...
		uint32_t getHauteur();
		//Renvoie l'image cible, modifiée pour simuler la vision d'un deutéranope.
		Image visionDeuteranopie();
		//Renvoie l'image cible, modifiée pour simuler la vision d'un protanope.
		Image visionProtanopie();
		//Renvoie l'image cible, modifiée pour simuler la vision d'un tritanope.
